...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        # self.epsilon = 1/math.pow(self.n_trial, 2)
        ...
        if testing:
            ...
            self.epsilon = math.exp( - (a * self.n_trial))
            self.n_trial += 1
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True,  alpha = 0.8, epsilon = 0.7)
    ...
    sim = Simulator(env, update_delay = 0.000001, display=False, log_metrics = True, optimized = True)
